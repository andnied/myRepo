...
namespace ComplaintTool.Visa.Model
{
    public class TC91
    {
        ...
        //{
        //    get { return string.IsNullOrEmpty(_reserved2) ? new string(' ', 18) : _reserved2.PadRight(18, ' '); }
        ...
        //{
        //    get { return string.IsNullOrEmpty(_reserved5) ? new string(' ', 15) : _reserved5.PadRight(15, ' '); }
        ...
        //{
        //    get { return string.IsNullOrEmpty(_reserved6) ? new string(' ', 7) : _reserved6.PadRight(7, ' '); }
        //    set { _reserved6 = value; }
        //}
        #endregion
        public TC91(string tcLine)
        {
            ...
            Reserved1 = tcLine.Substring(60, 6);
            CenterBatchID = tcLine.Substring(66, 8);
            NumberOfTransactions = tcLine.Substring(74, 9);
            Reserved2 = tcLine.Substring(83, 18);
            SourceAmount = tcLine.Substring(101, 15);
            Reserved3 = tcLine.Substring(116, 15);
            Reserved4 = tcLine.Substring(131, 15);
            Reserved5 = tcLine.Substring(146, 15);
            Reserved6 = tcLine.Substring(161, 7);
        }
    }
}
