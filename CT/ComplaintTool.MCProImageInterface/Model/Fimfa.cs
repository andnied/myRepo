...
namespace ComplaintTool.MCProImageInterface.Model
{
    ...
    public class Fimfa
    {
        ...
        [XmlElement(Order = 25, ElementName = "memo_txt")]
        ...
        [XmlElement(Order = 31, ElementName = "clnsd_merch_name")]
        public string CleansedMerchantName { get; set; }

        [XmlElement(Order = 32, ElementName = "clnsd_merch_ph_no")]
